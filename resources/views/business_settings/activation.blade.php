...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/paypal.png') }}" height="30">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/stripe.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/sslcommerz.png') }}" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/instamojo.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/rozarpay.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/paystack.png') }}" height="30">
                    <label class="switch pull-right">
...
<div class="row">
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/vogue.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/payhere.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/mpesa.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/flutterwave.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/ngenious.png') }}" height="30">
                    <label class="switch pull-right">
    ...
    <div class="col-lg-4">
        <div class="panel">
            ...
            <div class="panel-body text-center">
                <div class="clearfix">
                    <img loading="lazy"  class="pull-left" src="{{ static_asset('frontend/images/icons/cards/cod.png') }}" height="30">
                    <label class="switch pull-right">
